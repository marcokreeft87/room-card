...
describe('Testing index file class RoomCard', () => {
    ...
    test('Calling render without entity and only entities should return expected html', () => {   
        ...
        expect(htmlResult).toMatch('<ha-card elevation="2" style=""> <div class="card-header"> <div class="title" @click="" @dblclick=""> </div> <div class="entities-info-row"> </div> </div> <div class="entities-row content-left"><div class="entity" style="" @mousedown="start" @mouseup="end" @touchstart="start" @touchend="end" @touchcancel="end"> <span>test_entity2</span> <div><state-badge class="icon-small " .stateObj="" .overrideIcon="" .stateColor="" style="" ></state-badge></div> </div></div> </ha-card>');
    }),
    ...
    test('Calling render without entities, info_entities and rows should return expected html', () => {   
        ...
        expect(htmlResult).toMatch('<ha-card elevation="2" style=""> <div class="card-header"> <div class="title" @click="" @dblclick=""><div class="main-state entity" style=""> on </div> </div> <div class="entities-info-row"> </div> </div> <div class="entities-row content-left"></div> </ha-card>');
    }),
    test('Calling render without entities, info_entities and rows but with styles should return expected html', () => {   
        ...
        expect(htmlResult).toMatch('<ha-card elevation="2" style="color: red;"> <div class="card-header"> <div class="title" @click="" @dblclick=""><div class="main-state entity" style="color: red;"> on </div> </div> <div class="entities-info-row"> </div> </div> <div class="entities-row content-left"></div> </ha-card>');
    }),
    test('Calling render without only entities should return expected html', () => {   
        ...
        expect(htmlResult).toMatch('<ha-card elevation="2" style=""> <div class="card-header"> <div class="title" @click="" @dblclick=""><div class="main-state entity" style=""> <state-badge class="icon-small " .stateObj="" .overrideIcon="" .stateColor="" style="" ></state-badge> </div> </div> <div class="entities-info-row"> </div> </div> <div class="entities-row content-left"><div class="entity" style="" @mousedown="start" @mouseup="end" @touchstart="start" @touchend="end" @touchcancel="end"> <span>test_entity2</span> <div><state-badge class="icon-small " .stateObj="" .overrideIcon="" .stateColor="" style="" ></state-badge></div> </div></div> </ha-card>');
    }),
    ...
    test('Calling render with only info_entities and title should return expected html', () => {   
        ...
        expect(htmlResult).toMatch('<ha-card elevation="2" style=""> <div class="card-header"> <div class="title" @click="" @dblclick=""><div class="main-state entity" style=""> <state-badge class="icon-small " .stateObj="" .overrideIcon="" .stateColor="" style="" ></state-badge> </div> Test title</div> <div class="entities-info-row"> <div class="state entity " style="" @click="">on</div> </div> </div> <div class="entities-row content-left"></div> </ha-card>');
    }),
    ...
    test('Calling render with entities, info_entities and title should return expected html', () => {   
        ...
        expect(htmlResult).toMatch('<ha-card elevation="2" style=""> <div class="card-header"> <div class="title" @click="" @dblclick=""><div class="main-state entity" style=""> <state-badge class="icon-small " .stateObj="" .overrideIcon="" .stateColor="" style="" ></state-badge> </div> Test title</div> <div class="entities-info-row"> <div class="state entity " style="" @click="">on</div><div class="state entity " style="" @click="">on</div> </div> </div> <div class="entities-row content-left"><div class="entity" style="" @mousedown="start" @mouseup="end" @touchstart="start" @touchend="end" @touchcancel="end"> <span>test_entity2</span> <div><state-badge class="icon-small " .stateObj="" .overrideIcon="" .stateColor="" style="" ></state-badge></div> </div><div class="entity" style="" @mousedown="start" @mouseup="end" @touchstart="start" @touchend="end" @touchcancel="end"> <span>test_entity3</span> <div><state-badge class="icon-small " .stateObj="" .overrideIcon="" .stateColor="" style="" ></state-badge></div> </div></div> </ha-card>');
    }),
