...
var hideIf = function hideIf(stateObj, config, hass) {
  ...
  var value = config.attribute ? stateObj.attributes[config.attribute] : stateObj.state;
  var hideValues = [];
...
var entityIcon = function entityIcon(stateObj, config) {
...
var src_templateObject, _templateObject2, _templateObject3, _templateObject4, _templateObject5, _templateObject6, _templateObject7, _templateObject8, _templateObject9, _templateObject10;
...
console.info('%c ROOM-CARD %c 0.1.0', 'color: cyan; background: black; font-weight: bold;', 'color: darkblue; background: white; font-weight: bold;');
...
var RoomCard = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(RoomCard, [{
    ...
    value: function renderInfoEntity(stateObj, config) {
      ...
      return $(_templateObject3 || (_templateObject3 = src_taggedTemplateLiteral(["<div class=\"state entity ", "\" style=\"", "\" @click=\"", "\">", "</div>"])), config.show_icon === true ? 'icon-entity' : '', entityStyles(config), onClick, this.renderValue(stateObj, config));
    }
  }, {
    key: "renderEntity",
    value: function renderEntity(stateObj, config) {
      ...
      return $(_templateObject4 || (_templateObject4 = src_taggedTemplateLiteral(["<div class=\"entity\" style=\"", "\" @click=\"", "\" @dblclick=\"", "\">\n            <span>", "</span>\n            <div>", "</div>\n        </div>"])), entityStyles(config), onClick, onDblClick, entityName(stateObj, config), this.renderIcon(stateObj, config));
    }
  }, {
    ...
    value: function renderValue(stateObj, config) {
      ...
      if (config.format && TIMESTAMP_FORMATS.includes(config.format)) {
        ...
        return $(_templateObject8 || (_templateObject8 = src_taggedTemplateLiteral(["<hui-timestamp-display\n                .hass=", "\n                .ts=", "\n                .format=", "\n                capitalize\n            ></hui-timestamp-display>"])), this._hass, timestamp, config.format);
      }
    ...
    value: function renderIcon(stateObj, config, classes) {
      return $(_templateObject9 || (_templateObject9 = src_taggedTemplateLiteral(["<state-badge\n            class=\"icon-small ", "\"\n            .stateObj=\"", "\"\n            .overrideIcon=\"", "\"\n            .stateColor=\"", "\"\n        ></state-badge>"])), classes, stateObj, entityIcon(stateObj, config), config.state_color);
    }
  }, {
    key: "renderWarning",
    value: function renderWarning() {
      return $(_templateObject10 || (_templateObject10 = src_taggedTemplateLiteral(["<hui-warning>\n            ", "\n        </hui-warning>"])), this._hass.localize('ui.panel.lovelace.warning.entity_not_found', 'entity', this.config.entity));
    }
  }, {
    key: "clickHandler",
