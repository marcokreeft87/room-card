...
exports.holdHandler = exports.dblClickHandler = exports.clickHandler = exports.renderInfoEntity = exports.renderTitle = exports.renderMainEntity = exports.renderValue = exports.renderIcon = exports.renderEntity = exports.renderEntitiesRow = exports.entityStyles = exports.entityStateDisplay = exports.renderCustomStateIcon = exports.renderConditionIcons = exports.entityIcon = exports.entityName = exports.computeEntity = exports.checkConfig = void 0;
...
const renderEntitiesRow = (entities, hass, element, classes) => {
    return (0, lit_1.html) `<div class="entities-row ${classes}">
            ${entities.map((entity) => (0, exports.renderEntity)(entity, hass, element))}
        </div>`;
};
exports.renderEntitiesRow = renderEntitiesRow;
const renderEntity = (entity, hass, element) => {
    if (entity === undefined || entity.stateObj == undefined || (0, util_1.hideIf)(entity, hass)) {
        return null;
    }
...
const renderIcon = (stateObj, config, hass, classes) => {
    ...
    return (0, lit_1.html) `<state-badge
        ...
        style="${(0, exports.entityStyles)((0, util_1.isObject)(customIcon) ? customIcon.styles : null)}"
    ></state-badge>`;
};
...
const renderValue = (entity, hass) => {
    ...
    if (entity.attribute && [constants_1.LAST_CHANGED, constants_1.LAST_UPDATED].includes(entity.attribute)) {
        return (0, lit_1.html) `<ha-relative-time
            .hass=${hass}
            .datetime=${entity.stateObj.attributes[(_a = entity.attribute) === null || _a === void 0 ? void 0 : _a.replace('-', '_')]}
            capitalize
        ></ha-relative-time>`;
    }
